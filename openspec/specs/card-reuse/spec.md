...
Reusable `<app-card>` component that displays icon, title, and description in a contained card layout. Used across multiple sections (concept-section, commands-section, etc.) for consistent card presentation.

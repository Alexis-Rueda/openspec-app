...
ConceptSection component for the landing page. Displays "¿Qué es OpenSpec?" with eyebrow label, headline, lead paragraph, and a grid of 3 explanatory cards using the reusable `<app-card>` component.
